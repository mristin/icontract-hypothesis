...
class TestWithInferredStrategies(unittest.TestCase):
    ...
    def test_some_func(self) -> None:
        ...
        def execute(kwargs) -> None:
            tests.pyicontract_hypothesis.samples.sample_module.some_func(**kwargs)
    ...
    def test_another_func(self) -> None:
        ...
        def execute(kwargs) -> None:
            tests.pyicontract_hypothesis.samples.sample_module.another_func(**kwargs)
    ...
    def test_yet_another_func(self) -> None:
        ...
        def execute(kwargs) -> None:
            tests.pyicontract_hypothesis.samples.sample_module.yet_another_func(**kwargs)
